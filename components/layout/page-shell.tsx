  ...
  return (
    <article className={cn("border-b border-[var(--ink)]", className)}>
      <div className="mx-auto max-w-[1200px] px-4 py-14 sm:px-6 lg:px-10 lg:py-16">
        ...
        <h1 className="mt-3 font-mono text-3xl font-bold leading-[1.15] tracking-tight text-[var(--ink)] sm:text-4xl">
          {title}
        </h1>
        {lede && (
          <p className="prose-digicracy mt-4 text-base text-[var(--ink)] sm:text-[17px]">
            {lede}
          </p>
        )}
